...
| Test suite | **Done** (441 tests, 438 passing — see §5 and [`docs/tests.md`](docs/tests.md)) |
...
- **Test suite: 441 tests, no hard cap** — the source-of-truth count. PRD §4.5's original 100-cap was superseded 2026-05 (new modules with verifiable behaviour are exempt); keep the suite lean and high-signal, no low-value proliferation.
