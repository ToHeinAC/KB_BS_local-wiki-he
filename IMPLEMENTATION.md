...
| 6 | M6: Ontology ([plan](docs/_plan-ontology.md) phases 1–8) | in progress (plan phases 1–4 done) | `test_ontology`, `test_ontology_store`, `test_ontology_bundle`, `test_ontology_detect`, `test_ontology_ingest`, `test_ontology_query`, `test_ontology_search`, `test_delete_source`, `test_app`; `scripts/bench_ontology_detect.py`, `scripts/eval_ontology_search.py` |
...
| `ontology.py`, `ontology_bundle.py`, `ontology_store.py`, `ontology_detect.py`, `ontology_query.py`, `ontology_ui.py`, `ontology/*.yaml` | Ontology schema modules, validation, per-DB fact ledger, export/import with revisions, detection at upload, page stamping, the ontology stage in every search, Maintenance → Ontology ([docs/ontology.md](docs/ontology.md)) |
