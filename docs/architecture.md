...
| `src/ontology_ui.py` | **Maintenance → Ontology** section: revision + last (human/automatic) change, export, class tree, facts, history with diff/download/restore, import with preview and per-conflict choice. | Phase 2 |
