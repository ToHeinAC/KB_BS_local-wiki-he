...
**Ontology in search results** (DBs with an ontology): Explorer search shows a caption line "Ontology — “…” → `work`; n source(s) favoured"; Deep chat and Research traces show an *Ontology frame* expander; *Why these sources* lists the ontology frames of the answer. See [ontology.md](ontology.md) §Search.
