...
_STRINGS = {
    "de": {
        ...
        "clusters": "Cluster",
        "truncated": "gekürzt",
        "opened": "Doppelklick öffnet die Seite im Reader",
        "sourceNode": "Quelldokument (keine Wiki-Seite)",
        "rankPr": "Nach PageRank sortiert",
        "rankDeg": "Nach Verbindungen sortiert",
        "rankAll": "gesamter Graph",
        "rankSel": "Auswahl",
        "empty": "Noch keine verknüpften Seiten.",
        "rankOf": "Rang 1 … {n}",
        "sizeIs": "Fläche = {metric}",
    },
    "en": {
        "search": "Search pages…",
        "type": "Type",
        ...
        "clusters": "clusters",
        "truncated": "truncated",
        "opened": "Double-click opens the page in the reader",
        "sourceNode": "Source document (not a wiki page)",
        "rankPr": "Ranked by PageRank",
        "rankDeg": "Ranked by connections",
        "rankAll": "whole graph",
        "rankSel": "selection",
